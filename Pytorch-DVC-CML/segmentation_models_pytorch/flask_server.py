...
handler.setLevel(logging.INFO)  # choose the level of logging you want
...
def predict():
    ...
    try:
        ...
        data_length = len(image_bytes.getvalue())
        minio_client.put_object("images", f"{image_id}.npy", image_bytes, data_length, "application/numpy")
        ...
        data_length = len(entropy_bytes.getvalue())
        minio_client.put_object("entropies", f"{image_id}.npy", entropy_bytes, data_length, "application/numpy")
